...
$error = '';
$values = [
    'name' => '', 'email' => '', 'phone' => '', 'postal_address' => '', 'referral' => '',
    'event_type' => '', 'event_date' => '', 'venue' => '', 'guest_count' => '', 'budget' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($honeypot !== '') {
        $success = true;
    } elseif ($values['name'] === '' || $values['event_type'] === '' || $values['phone'] === '' || $values['postal_address'] === '') {
        $error = 'Merci de renseigner votre nom, votre téléphone, votre adresse postale et le type d’événement.';
        ...
        $stmt->execute([
            ...
            ':postal_address'=>$values['postal_address'], ':referral'=>$values['referral'] ?: null,
  ...
  <?php else: ?>
    ...
    <form method="post" class="quote-form">
      ...
      <div class="quote-grid">
        ...
        <div class="quote-field"><label for="postal_address">Adresse postale *</label><input id="postal_address" name="postal_address" value="<?= e($values['postal_address']) ?>" required autocomplete="street-address"></div>
